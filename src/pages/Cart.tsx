...
import { Pizza, clearItems, selectCart } from '../redux/slices/cartSlice.ts';
        ...
        items.length ? <>
          ...
          <div className="container container--cart">
            <div className="cart cart--empty">
              <h2>Корзина пуста 😕</h2>
              <p>
                Ви ще не добавили жодної піци.<br />
                Для того щоб замовити піцу перейди на головну
              </p>
              <img src="/img/empty-cart.png" alt="Empty cart" />
              <Link to={'/'} className="button button--black">Повернутися назад</Link>
            </div>
          </div>
        </div>
      }
